 ...
 */
final class Version20230531085101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE weather (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, date DATETIME NOT NULL, temperature DOUBLE PRECISION DEFAULT NULL, clouds DOUBLE PRECISION DEFAULT NULL, INDEX IDX_4CD0D36E8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
